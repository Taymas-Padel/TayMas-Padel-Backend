...
# Все временные файлы загрузки (в т.ч. большие фото) складываем не в /tmp,
# а внутрь MEDIA_ROOT, чтобы на них сразу вешалась правильная SELinux-метка.
FILE_UPLOAD_TEMP_DIR = os.path.join(BASE_DIR, 'media', 'tmp_uploads')
